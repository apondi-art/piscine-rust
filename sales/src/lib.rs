...
impl Cart {
    ...
    pub fn generate_receipt(&mut self) -> Vec<f32> {
        ...
        // Ensure the sum of adjusted prices matches total_after_discount (handle floating point precision)
        ...
        if discrepancy.abs() > 0.001 {
            ...
            adjusted_prices[last_index] = (adjusted_prices[last_index] * 100.0).round() / 100.0;
        }
